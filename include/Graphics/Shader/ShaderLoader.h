...
namespace lu
{
    namespace graphics
    {
        ...
        /**
         * \brief ShaderProperty structure describing what a shader should
         * contain
         */
        struct ShaderProperties
        {
                ...
                {
                    return (vPath == other.vPath && fPath == other.fPath &&
                            gPath == other.gPath);
                }
        };
         ...
         *
         * Together with shader properties we make sure we only ever load a
         * shader with the same properties once.
         */
        class ShaderLoader
        {
            private:
                static std::vector<std::pair<lu::graphics::ShaderProperties,
                                             lu::graphics::Shader>>
                  m_loadedShaders;

            protected:
                /**
                 * \brief compiles shader code into a program and returns the
                 * shader
                 *
                 ...
                 */
                Shader loadFromSource(const GLchar *vertexSource,
            ...
            public:
                ...
                /**
                 * \breif Check if a shader with ShaderProperties has been
                 * loaded previously
                 *
                 * @param properties ShaderProperties describing the shader
