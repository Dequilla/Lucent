...
namespace lu
{
    namespace graphics
    {
        ...
        /**
         * \brief Material properties to describe some of what it needs to
         * function
         *
        ...
        {
            MAT_BLEND = 0x01 /**< Material should be blent with glBlend
                                (contains opacity) */
        };
        ...
        struct Material
        {
                ...
                std::vector<Texture>
                  textures; /**< Textures used in this material */
